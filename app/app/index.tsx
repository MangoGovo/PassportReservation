...
type ProtectedTarget = '/reserve' | '/reservations' | '/pass/demo';
...
export default function HomeScreen() {
  ...
  const openAuthGate = (nextTarget: ProtectedTarget) => {
  ...
  return (
    <>
      ...
      <ScreenContainer bottom={<BottomTabs active="home" onPassPress={() => openAuthGate('/pass/demo')} />}>

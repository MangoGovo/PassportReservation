...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='手机端注册用户表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='预约主表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='公务预约审核记录表';
